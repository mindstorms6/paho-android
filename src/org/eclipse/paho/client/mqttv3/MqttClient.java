...
public class MqttClient implements DestinationProvider {
	 ...
	 */
	public MqttClient(String serverURI, String clientId,WakeLock wl) throws MqttException {
		this(serverURI,clientId, new MqttDefaultFilePersistence(),wl);
	}
	 ...
	 * @throws MqttException if any other problem was encountered 
	 */
	public MqttClient(String serverURI, String clientId, MqttClientPersistence persistence, WakeLock wl) throws MqttException {
		...
		this.comms = new ClientComms(this, this.persistence, trace,this.wl);
